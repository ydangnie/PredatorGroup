                    ...
                    <div class="whcart_summary_inner_z19a">
                        ...
                        <div class="whcart_summary_rows_z19a">
                            ...
                            <div class="whcart_summary_row_z19a">
                                ...
                                <div class="whcart_summary_row_value_z19a" id="cart-discount">
                                    @if(session('coupon'))
                            ...
                            <div class="whcart_summary_row_z19a whcart_summary_row_important_z19a whcart_summary_row_total_z19a">
                                ...
                                <div class="whcart_summary_row_value_z19a" id="cart-total">
                                    @if(session('coupon'))
                                    {{ number_format($grandTotal - session('coupon')['discount'], 0, ',', '.') }}₫
                                    @else
                        ...
                        <div class="whcart_summary_coupon_z19a">
                            ...
                            <div class="whcart_summary_coupon_fieldrow_z19a">
                                ...
                                <button type="button" class="whcart_summary_coupon_button_z19a" onclick="applyCoupon()">Áp dụng</button>
                            </div>
                        </div>
